...
class VariableFontFace(ABCFontFace):
    ...
    @family_names.setter
    def family_names(self: VariableFontFace, value: Any) -> None:
    ...
    @exact_names.setter
    def exact_names(self: VariableFontFace, value: Any) -> None:
    ...
    def is_glyph_emboldened(self: VariableFontFace, value: Any) -> None:
    ...
    def __eq__(self: VariableFontFace, other: object) -> bool:
